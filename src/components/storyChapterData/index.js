export const theStory = [
  {
    chapter: 0, //intro
    chapterHeader: "The Evil Dark Elves",
    chapterText:
  ...
  {
    chapter: 1, //selection
    chapterHeader: "Preparing for the Adventure",
    chapterText:
      "Player has to chose one object and one spell, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex eacommodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sintoccaecat cupidatat non proident, sunt in culpa qui officia deseruntmollit anim id est laborum.",
  },
  {
    chapter:2,
  ...
  {
    chapter:7,
    chapterHeader:"Defeated.",
    chapterText:"You woke up from your unconscioness and see the old man burning in flame. The goblin look at you and with a smile said: you are next!. You die in big pain. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex eacommodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sintoccaecat cupidatat non proident, sunt in culpa qui officia deseruntmollit anim id est laborum.",
    src:"/images/defeatedbyGoblin.jpg"
  },
  {
    chapter:8,
    chapterHeader:"Final Destination.",
    chapterText:"You arrived to the town in time to deliver your special weapon to your master and safe the city from the attack of the elves. Well done!. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex eacommodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sintoccaecat cupidatat non proident, sunt in culpa qui officia deseruntmollit anim id est laborum.",
    src:"/images/portTown.jpg"
  }
];
...
export const modalData = [
  {
    item: "shield",
    modalHeader: "The Warrior Shield",
    modalText:
      " THE SHIELD description Lorem ipsum dolor sit amet consectetur adipisicing elit. Quorepellendus reprehenderit accusamus totam ratione! Nesciunt, nemo dolorum ",
    alt: "a shield",
    src: "/images/shield.jpg",
  },
  {
    item: "rope",
    modalHeader: "The Magic Rope",
    modalText:
      " THE ROPE description Lorem ipsum dolor sit amet consectetur adipisicing elit. Quorepellendus reprehenderit accusamus totam ratione! Nesciunt, nemo dolorum ",
    alt: "a rope",
    src: "/images/rope.jpg",
  },
  {
    item: "bag of coins",
    modalHeader: "A Bag Full Of Coins",
    modalText:
      " A BAG OF COINS description Lorem ipsum dolor sit amet consectetur adipisicing elit. Quorepellendus reprehenderit accusamus totam ratione! Nesciunt, nemo dolorum ",
    alt: "a bag of coins",
